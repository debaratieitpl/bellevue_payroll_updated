...
<div class="content">
   ...
   <div class="animated fadeIn">
      <div class="row" style="border:none;">
         <div class="col-md-6">
            <h5 class="card-title">Employee Contract Renew Report</h5>
         </div>
         <div class="col-md-6">
            <span class="right-brd" style="padding-right:15x;">
               <ul class="">
                  ...
                  <li>/</li>
                  <li class="active"> Contract Renew Report</li>
               </ul>
            </span>
         </div>
      </div>
         ...
         <div class="main-card">
            ...
            <div class="card">
               <div class="card-header">
                  <form  method="post" action="{{ url('employees/contract-renew-export-report') }}" enctype="multipart/form-data" >
                     ...
                     <table id="bootstrap-data-table" class="table table-striped table-bordered">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td>{{$record->contract_renew_date}}</td>
                           </tr>
                           @endforeach
                        </tbody>
                     </table>
