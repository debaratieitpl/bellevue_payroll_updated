...
<div class="content">
   ...
   <div class="animated fadeIn">
      <div class="row" style="border:none;">
         <div class="col-md-6">
            <h5 class="card-title">Employee Increment Report</h5>
         </div>
         <div class="col-md-6">
         ...
         <div class="main-card">
            ...
            <div class="card">
               <div class="card-header">
                  <form  method="post" action="{{ url('employees/increment-export-report') }}" enctype="multipart/form-data" >
                     ...
                     <table id="bootstrap-data-table" class="table table-striped table-bordered">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td>{{$record->emp_next_increament_date}}</td>
                           </tr>
                           @endforeach
                        </tbody>
                     </table>
