                ...
                <div class="col-md-6">
                    ...
                    <span class="right-brd" style="padding-right:15x;">
                        <ul class="">
                            ...
                            <li>/</li>
                            <li class="active">Employee Wise Entry</li>
                ...
                <div class="main-card">
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            ...
                            <!--Search Payslip-->
                            <form style="padding: 5px 10px 15px 20px !important;" action="{{ url('employees/entry-wise-list') }}" method="post">
                              <h5 class="card-title">Employee Wise Entry</h5>
                    ...
                    <h5 class="card-title">View Entry</h5> <br>
                    <div class="card">
