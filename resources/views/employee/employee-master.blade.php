                                    ...
                                    <table border="1" class="table table-bordered table-responsove" style="border-collapse:collapse;overflow-x:scroll;">
                                       ...
                                       <tbody id="marksheetearn">
                                          ...
                                          <tr class="itemslotpayearn" id="<?php echo $tr_id; ?>">
                                             ...
                                             <td>
                                                <select class="form-control" name="head_type[]" id="head_type<?php echo $tr_id; ?>" onchange="checkearnvalue(this.value,<?php echo $tr_id; ?>);">
                                                   <option value='' selected>Select</option>
                                    ...
                                    <table border="1" class="table table-bordered table-responsove" style="border-collapse:collapse;overflow-x:scroll;">
                                       ...
                                       <tbody id="marksheetdeduct">
                                          ...
                                          <tr class="itemslotpaydeduct" id="<?php echo $tr_id; ?>">
                                             ...
                                             <td>
                                                <select class="form-control" name="head_typededuct[]" id="head_typededuct<?php echo $tr_id; ?>" onchange="checkdeductvalue(this.value,<?php echo $tr_id; ?>);">
                                                   <option value='' selected>Select</option>
                                                   <option value='F'>Fixed</option>
                                                   <option value='V'>Variable</option>
                                                </select>
