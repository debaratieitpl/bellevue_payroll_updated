...
<body>
   ...
   <div class="main-dash">
      <div class="wrapper">
         <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                @if($requir == 'Requirement_Management')
   ...
   <!-- Vendor JS       -->
   <script src="{{ asset('vendor-main-dash/slick/slick.min.js')}}"></script>
   ...
   <script src="{{ asset('vendor-main-dash/bootstrap-progressbar/bootstrap-progressbar.min.js')}}"></script>
   <script src="{{ asset('vendor-main-dash/counter-up/jquery.waypoints.min.js')}}"></script>
   <script src="{{ asset('vendor-main-dash/counter-up/jquery.counterup.min.js')}}"></script>
   ...
   <script src="{{ asset('vendor-main-dash/select2/select2.min.js')}}"></script>
   <!-- Main JS-->
