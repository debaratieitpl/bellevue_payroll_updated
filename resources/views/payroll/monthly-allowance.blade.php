			...
			<div class="main-card">
				...
				<div class="card">
					...
					<div class="card-body card-block">
						...
						<div class="px-5">
					        <a href="{{route('payroll.vw-montly-allowances.export').'?month='.$req_month}}">
                    ...
                    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                          <form style='padding: 0px;' action="{{route('payroll.vw-montly-allowances.import').'?month='.$req_month}}" method="post" enctype="multipart/form-data">
                              @csrf
